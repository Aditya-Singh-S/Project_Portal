...
import com.cts.project.dto.Application;
...
public class ProjectController {
	...
	//Only EMPLOYEE
	//calling ApplicationService to apply for project
	@PostMapping("/apply")
	public ResponseEntity<Application> apply(@RequestParam int empid, @RequestParam int projectid){
		return null;
	}
}
